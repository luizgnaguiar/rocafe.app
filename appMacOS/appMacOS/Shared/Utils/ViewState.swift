...
/// A wrapper struct to make any Error identifiable for use in SwiftUI alerts and other views.
...
// Extension to provide easy access to error description from ViewState
extension ViewState {
